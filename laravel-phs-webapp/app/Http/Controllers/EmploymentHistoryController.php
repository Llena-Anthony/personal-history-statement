    ...
    public function store(Request $request)
    {
        ...
        if ($isSaveOnly) {
            ...
            $validated = $request->validate([
                ...
                'employment.*.from_month' => 'required|string|max:2',
                'employment.*.from_year' => 'required|integer|min:1900|max:2030',
                'employment.*.to_month' => 'nullable|string|max:2',
                'employment.*.to_year' => 'nullable|integer|min:1900|max:2030',
                'employment.*.type' => 'required|string|max:255',
                'employment.*.employer_name' => 'required|string|max:255',
                'employment.*.employer_address' => 'required|string|max:255',
                'employment.*.reason_leaving' => 'nullable|string|max:255',
