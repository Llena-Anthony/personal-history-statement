...
class PersonalDetailsController extends Controller
{
    ...
    {
        \Log::info('Personnel PersonalDetails create method called');
    ...
    {
        \Log::info('Personnel PersonalDetails store method called', [
            'user_id' => auth()->id(),
        ...
        try {
            ...
            if ($request->ajax()) {
                $nextRoute = route('personnel.phs.personal-characteristics.create');
            ...
            \Log::error('Exception in Personnel PersonalDetailsController@store', ['message' => $e->getMessage(), 'trace' => $e->getTraceAsString()]);
            if ($isSaveOnly || $request->ajax()) {
