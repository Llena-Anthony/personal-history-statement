...
<body class="bg-gradient-to-br from-gray-50 to-gray-100 min-h-screen">
    ...
    <div id="phsModal" class="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50 hidden">
        <div class="bg-white rounded-xl max-w-xl w-full p-8 text-gray-800 relative">
            <h2 class="text-2xl font-bold text-center mb-4">PERSONAL HISTORY STATEMENT (PHS)</h2>
            ...
            <div class="text-center">
                <button onclick="closePHSModal()" class="bg-[#1B365D] hover:bg-[#2B4B7D] text-white px-6 py-2 rounded">
                    OK
                </button>
            </div>
        </div>
    ...
    <script>
        window.onload = function () {
            document.getElementById('phsModal').classList.remove('hidden');
        }

        function closePHSModal() {
            document.getElementById('phsModal').classList.add('hidden');
        }
    </script>
</body>
</html> 