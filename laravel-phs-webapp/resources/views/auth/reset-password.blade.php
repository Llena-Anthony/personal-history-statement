...
<head>
    ...
    <title>Reset Password - Personal History Statement</title>
    ...
    <div class="flex w-full max-w-7xl bg-white rounded-2xl shadow-2xl overflow-hidden">
        ...
        <div class="w-1/2 p-16">
            <div class="text-center mb-12 fade-in">
                ...
                <p class="text-gray-600 text-lg">Enter your new password</p>
            </div>
            ...
            <form method="POST" action="{{ route('password.update') }}" class="space-y-8 fade-in" style="animation-delay: 0.1s;">
                @csrf
                ...
                <div>
                    <label for="password" class="block text-sm font-medium text-[#1B365D] mb-2">New Password</label>
                    <div class="relative">
                        <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                ...
                <div>
                    <label for="password_confirmation" class="block text-sm font-medium text-[#1B365D] mb-2">Confirm New Password</label>
                    <div class="relative">
                        <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                            <i class="fas fa-lock text-gray-400"></i>
                        </div>
                        <input type="password" name="password_confirmation" id="password_confirmation" required
                            class="input-field block w-full pl-12 pr-4 py-4 border {{ $errors->has('password_confirmation') ? 'border-red-300 text-red-900 placeholder-red-300 focus:ring-red-500 focus:border-red-500' : 'border-gray-200 focus:ring-[#1B365D] focus:border-[#1B365D]' }} rounded-xl bg-gray-50 focus:outline-none">
                    </div>
                </div>
