@php
    $formAction = route('phs.educational-background.store');
    $nextSectionRoute = route('phs.military-history.create');
...
<div class="max-w-4xl mx-auto">
    ...
    <form method="POST" action="{{ $formAction }}" class="space-y-8">
        ...
        <div class="flex justify-between items-center pt-6 border-t border-gray-200">
            ...
            <button type="submit" class="btn-primary" formaction="{{ route('phs.military-history.create') }}">
                Save & Continue
