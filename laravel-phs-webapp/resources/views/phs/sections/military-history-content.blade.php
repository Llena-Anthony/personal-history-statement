...
<div class="mb-8">
    <div class="flex items-center space-x-4 mb-4">
        ...
        <div>
            <h1 class="text-3xl font-bold text-[#1B365D]">VI: Military History</h1>
            <p class="text-gray-600">Please provide your military service information</p>
        </div>
    </div>
</div>
<form id="military-history-form" action="{{ route('phs.military-history.store') }}" method="POST" onsubmit="return handleFormSubmit(event, 'military-history')" class="max-w-4xl mx-auto">
    @csrf
    <!-- Basic Information -->
    ...
    <!-- Navigation Buttons -->
    <div class="flex justify-between items-center pt-6 border-t border-gray-200 w-full">
