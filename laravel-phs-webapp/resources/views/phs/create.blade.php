...
<div class="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 relative">
    ...
    <div class="relative flex min-h-screen">
        <!-- Fixed Sidebar -->
        <aside class="w-72 bg-white shadow-lg fixed top-0 left-0 h-screen overflow-y-auto z-40">
            ...
            <nav class="p-6 bg-white">
                <ul class="space-y-4">
                    <li>
                        <a href="{{ route('phs.create') }}" class="flex items-center text-gray-600 hover:text-gray-900 transition-colors">
                            <span class="w-6 h-6 rounded-full bg-yellow-400 flex items-center justify-center mr-3">
                                <span class="text-xs text-white">I</span>
                            </span>
                            <span class="text-black font-medium">Personal Details</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('phs.personal-characteristics.create') }}" class="flex items-center text-gray-600 hover:text-gray-900 transition-colors">
                ...
                <div class="bg-white/95 backdrop-blur-sm rounded-xl shadow-lg p-8 mb-8">
                    ...
                    <form method="POST" action="{{ route('phs.store') }}" class="space-y-8">
                        ...
                        <fieldset class="bg-gray-50/80 backdrop-blur-sm rounded-lg p-6 border border-gray-100">
                            <legend class="text-lg font-semibold text-[#1B365D] mb-4 px-2">Name Information</legend>
                        ...
                        <fieldset class="bg-gray-50/80 backdrop-blur-sm rounded-lg p-6 border border-gray-100">
                            <legend class="text-lg font-semibold text-[#1B365D] mb-4 px-2">Military Information</legend>
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div class="space-y-2">
                                ...
                                <div class="space-y-2">
                                    <label class="block text-sm font-medium text-gray-700">AFPSN</label>
                                ...
                                <div class="space-y-2">
                                    <label class="block text-sm font-medium text-gray-700">Present Job / Assignment</label>
                        ...
                        <fieldset class="bg-gray-50/80 backdrop-blur-sm rounded-lg p-6 border border-gray-100">
                            <legend class="text-lg font-semibold text-[#1B365D] mb-4 px-2">Personal Information</legend>
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div class="space-y-2">
                        ...
                        <!-- Contact Information -->
                        <fieldset class="bg-gray-50/80 backdrop-blur-sm rounded-lg p-6 border border-gray-100">
                            <legend class="text-lg font-semibold text-[#1B365D] mb-4 px-2">Contact Information</legend>
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div class="space-y-2">
                                ...
                                <div class="space-y-2">
                                    <label class="block text-sm font-medium text-gray-700">Business / Duty Address</label>
                                ...
                                <div class="space-y-2">
                                    <label class="block text-sm font-medium text-gray-700">Mobile / Telephone Number</label>
                        ...
                        <fieldset class="bg-gray-50/80 backdrop-blur-sm rounded-lg p-6 border border-gray-100">
                            <legend class="text-lg font-semibold text-[#1B365D] mb-4 px-2">Additional Information</legend>
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div class="space-y-2">
                                    <label class="block text-sm font-medium text-gray-700">Change in Name</label>
                        ...
                        <fieldset class="bg-gray-50/80 backdrop-blur-sm rounded-lg p-6 border border-gray-100">
                            <legend class="text-lg font-semibold text-[#1B365D] mb-4 px-2">Identification Numbers</legend>
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        const citizenshipSelect = document.querySelector('select[name="nationality"]');
