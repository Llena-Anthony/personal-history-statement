...
<html lang="en">
    ...
    <body class="bg-white m-0 p-0">
		...
		<div class="text-justify font-sans text-[11pt] bg-white" id='printable-area'>
            {{-- Page 1 --}}
            <div class="page">
            <div  class="h-[11.69in] w-[8.27in] border-dashed border-gray border-[1px] relative ">
                ...
                <div class="flex ml-[0.6in]"><span class="mr-[0.5in]">B.</span>
                    ...
                    AFPSN:<div id="app-num" class="border-b border-black text-[11pt] text-center ml-auto w-[1.5in]"></div>
                    Br of Svc:<div id="app-branch" class="border-b border-black text-[11pt] text-center ml-auto w-[1.5in]"></div>
                </div>
